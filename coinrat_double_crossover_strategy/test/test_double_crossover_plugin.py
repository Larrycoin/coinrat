...
def test_plugin():
    ...
    assert isinstance(strategy_plugin.get_strategy('double_crossover', flexmock(), flexmock()), DoubleCrossoverStrategy)
    with pytest.raises(ValueError):
        strategy_plugin.get_strategy('gandalf', flexmock(), flexmock())
