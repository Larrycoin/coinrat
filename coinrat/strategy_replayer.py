...
class StrategyReplayer(StrategyRunner):
    ...
    def run(self, strategy_run: StrategyRun):
        ...
        order_storage = self._orders_storage_plugins.get_order_storage(strategy_run.order_storage_name)
        ...
        market = self._market_plugins.get_market(
            'mock',
            datetime_factory,
            format_data_to_python_types(strategy_run.market_configuration, market_class.get_configuration_structure())
        )
