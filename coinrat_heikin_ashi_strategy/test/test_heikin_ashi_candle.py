...
def test_create_initial_heikin_ashi_candle():
    candle = Candle('', Pair('USD', 'BTC'), DUMMY_DATE, Decimal(2000), Decimal(4000), Decimal(1000), Decimal(3000))
    ha_candle = create_initial_heikin_ashi_candle(candle)
    assert str(ha_candle) == '2017-01-01T00:00:00+00:00 ' \
           + 'O:2500.00000000 H:4000.00000000 L:1000.00000000 C:2500.00000000 | CandleSize: 1-minute (Heikin-Ashi)'


def test_candle_to_heikin_ashi():
    previous_ha_candle = HeikinAshiCandle(
        '', Pair('USD', 'BTC'), DUMMY_DATE, Decimal(2500), Decimal(4000), Decimal(1000), Decimal(2500),
    )
